...
class RWSWScore(ISTUtama):
    ...
    def __init__(self, parent):
        ...
        self.parent.m_textCtrl_nilai_rw_ra.SetValue(str(self.parent.rw[4]))
        self.parent.m_textCtrl_nilai_rw_zr.SetValue(str(self.parent.rw[5]))
        self.parent.m_textCtrl_nilai_rw_fa.SetValue(str(self.parent.rw[6]))
        self.parent.m_textCtrl_nilai_rw_wu.SetValue(str(self.parent.rw[7]))
        self.parent.m_textCtrl_nilai_rw_me.SetValue(str(self.parent.rw[8]))
        self.parent.sum = []
        ...
        self.parent.m_textCtrl_nilai_sw_ra.SetValue(str(self.parent.sw[4]))
        self.parent.m_textCtrl_nilai_sw_zr.SetValue(str(self.parent.sw[5]))
        self.parent.m_textCtrl_nilai_sw_fa.SetValue(str(self.parent.sw[6]))
        self.parent.m_textCtrl_nilai_sw_wu.SetValue(str(self.parent.sw[7]))
        self.parent.m_textCtrl_nilai_sw_me.SetValue(str(self.parent.sw[8]))
