...
from views.properties_ist import ISTInheritedProperties 
from views.properties_tampilan import PropertiesTampilan, AddTextCtrlProperties
...
class ISTISTUtama( ISTInheritedProperties ):
	def __init__( self, parent ,*args,**kwds):
		...
		self.properties_tamp.grafik_show()
